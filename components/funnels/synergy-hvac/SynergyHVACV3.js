...
function Testimonial() {
  return (
    <figure className="testimonial">
      ...
      <div>
        <blockquote>&ldquo;Their customer service is second to none! I will use no other company than Synergy Home from here on out. Highly recommended! Five stars all around!&rdquo;</blockquote>
        <figcaption>
...
export default function SynergyHVACV3({
  funnelId,
  funnelSlug,
  clientId,
  stepId,
        ...
        <div className="survey-shell survey-shell--centered" data-theme="forest">
          <main className="stage">
              ...
              <div className="v3-form-card">
                <form onSubmit={handleSubmit}>
                  <div className="v3-form-head">
                    <h2>Schedule your free visit</h2>
                    <p>No multi-step survey. We&apos;ll call to schedule your HVAC assessment.</p>
                  </div>
                  ...
                  <div className="v3-form-foot">
                    <button type="submit" className="btn-primary" disabled={!canSubmit || submitting}>
                      {submitting ? 'Sending…' : 'Get my free second opinion'}
            ...
            <footer className="stage-foot">
              <span>&copy;2026 Synergy Home. All Rights Reserved.</span>
