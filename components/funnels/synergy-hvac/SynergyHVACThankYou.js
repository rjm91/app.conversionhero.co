...
function CompleteCard({ city, firstName }) {
  return (
    <div className="complete">
      ...
      <h2 className="complete-title">Your free second opinion is booked.</h2>
      <p className="complete-sub">
        {firstName ? <>Thanks, <strong>{firstName}</strong>. </> : null}
        A Synergy Home advisor will reach out as soon as possible to schedule your free HVAC second opinion{city ? <> in <strong>{city}</strong></> : null}.
      </p>
      <div className="complete-next">
        ...
        <div className="next-row"><span className="next-num">02</span><span className="next-label">On-site assessment <em>· typically within a week</em></span></div>
...
export default function SynergyHVACThankYou({
  funnelId,
  clientId,
  branding = {},
  tracking = {},
