...
const NAV_GROUPS = {
  ...
  admin: {
    ...
    items: [
      ...
      { key: 'agencies', label: 'Agencies', adminOnly: true, icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 21h18M5 21V7l8-4v18M19 21V11l-6-4M9 9v.01M9 12v.01M9 15v.01M9 18v.01" /></svg> },
