...
const NAV_GROUPS = {
  ...
  admin: {
    ...
    items: [
      ...
      { key: 'schema', label: 'Schema Map', securityOnly: true, icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6a2 2 0 012-2h4a2 2 0 012 2v2H4V6zm0 4h8m0 0h8a0 0 0 000 0v8a2 2 0 01-2 2h-4a2 2 0 01-2-2v-8zm0 0H4v8a2 2 0 002 2h4a2 2 0 002-2v-8z" /></svg> },
      { key: 'agencies', label: 'Agencies', securityOnly: true, icon: <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 21h18M5 21V7l8-4v18M19 21V11l-6-4M9 9v.01M9 12v.01M9 15v.01M9 18v.01" /></svg> },
