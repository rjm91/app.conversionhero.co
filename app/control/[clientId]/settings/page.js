      ...
      {clientId === 'ch069' && (
        <section aria-labelledby="chorus-access-heading">
          <div className="flex items-start justify-between gap-4 mb-3">
            <div>
              <h2 id="chorus-access-heading" className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Chorus data access</h2>
              <p className="text-sm text-gray-400 mt-1">Reference for the authorized ShieldTech MCP connection</p>
            </div>
          ...
          <div className="bg-white dark:bg-[#171B33] rounded-xl border border-gray-100 dark:border-white/5 overflow-hidden">
            <div className="px-6 py-5 border-b border-gray-100 dark:border-white/5">
              <p className="text-sm text-gray-700 dark:text-gray-300 leading-6">
                Chorus can read the approved ShieldTech reporting surface to answer questions and prepare the daily P&amp;L digest. It cannot make changes to ShieldTech data, access another client, or retrieve connection credentials.
              </p>
            </div>
