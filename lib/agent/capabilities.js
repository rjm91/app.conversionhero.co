...
const META = {
  ...
  getClientSummary: {
    ...
    what: 'Reads a high-level client snapshot: lead counts, order counts, script counts, statuses, assets.',
    access: 'read', touches: 'client, client_lead, client_orders, client_video_scripts',
  },
  getAllClientsLeads: {
    group: 'Data & Reporting',
