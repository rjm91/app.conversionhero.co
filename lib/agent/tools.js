...
export const TOOL_DEFINITIONS = [
  ...
  {
    name: 'getBrandBoard',
    description: "Get a client's brand board: their brand colors (array of { role, hex }), brand name, tagline, and font. Use whenever you need the client's brand styling — e.g. when building or styling a funnel, landing page, or any branded asset. Returns empty colors if the client has not set up a brand board yet.",
    input_schema: {
      type: 'object',
      properties: { clientId: { type: 'string' } },
      required: ['clientId'],
...
const PROPOSAL_TOOLS = new Set(['proposeCreateScript', 'proposeUpdateScript', 'proposeAgreement'])
