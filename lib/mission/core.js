...
export function computeMission({ orders, google, meta, googleDaily = [], metaDaily = [], mfg, start, end, newEmails = null, pnlConfig = {} }) {
  ...
  return {
    ...
    sources: {
      ...
      // AOV dial — saved override; unset means "use the history-derived default"
      aovRedBelow: pnlConfig.aovRedBelow != null ? Number(pnlConfig.aovRedBelow) : null,
      aovGreenAbove: pnlConfig.aovGreenAbove != null ? Number(pnlConfig.aovGreenAbove) : null,
    },
