...
- **Undo** — every ledger row has an ↩ undo that moves the decision back
  to PROBLEMS as an open card. Decisions are reversible, like an IDE.
...
- **The agent has UI-only hands.** It can open tabs, change the range,
  reopen a ledger decision into PROBLEMS, and draft new cards for your
  approval — each action narrated in the terminal as it happens. It can
  NEVER approve its own cards or touch ad platforms; those stay yours.
