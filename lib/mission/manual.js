...
- **Channel attribution** — last-touch Shopify UTM source (merged source, then
  explicit last visit, then first visit). Klaviyo/owned touches never count as
  Google or Meta revenue merely because an earlier paid touch exists
