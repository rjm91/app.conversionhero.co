...
import SynergySprayFoamV2 from '../components/funnels/synergy-spray-foam/SynergySprayFoamV2'
import SynergySprayFoamThankYou from '../components/funnels/synergy-spray-foam/SynergySprayFoamThankYou'
import HeritageShutters from '../components/funnels/heritage-shutters/HeritageShutters'
import HeritageShuttersThankYou from '../components/funnels/heritage-shutters/HeritageShuttersThankYou'
...
const SURVEY_COMPONENTS = {
  ...
  'SynergySprayFoam': SynergySprayFoam,
  'SynergySprayFoamV2': SynergySprayFoamV2,
}
...
const CODE_FUNNELS = {
  ...
  'spray-foam': {
    survey: SynergySprayFoam,
    thankYou: SynergySprayFoamThankYou,
  },
  'demo-hvac-quote': {
    survey: SynergyHVAC,
    thankYou: SynergyHVACThankYou,
  },
  'demo-generator-quote': {
    survey: SynergyGenerator,
    thankYou: SynergyGeneratorThankYou,
  },
  'heritage-shutters-quote': {
    survey: HeritageShutters,
    thankYou: HeritageShuttersThankYou,
  },
}
