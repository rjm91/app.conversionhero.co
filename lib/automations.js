...
async function runLeadEmail(rule, lead) {
  ...
  const vars = {
    ...
    utm_adgroup: lead.utm_adgroup || meta.adgroup || meta.ad_group_id || meta.utm_adgroup || '',
    ad_group_id: lead.utm_adgroup || meta.adgroup || meta.ad_group_id || meta.utm_adgroup || '',
