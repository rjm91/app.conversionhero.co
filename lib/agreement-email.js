...
export function defaultTermsText({ customer = {}, agreement = {} }) {
  ...
  const adLine = agreement.adOn
    ? `- Ad-spend commission: in any month where managed ad spend exceeds $10,000, a ${adPct}% commission applies to the full ad spend for that month, billed monthly. Months at or under $10,000 incur no commission.\n`
    : ''
  return `1. Parties
...
Provider will produce ${videos} short-form videos per month under the ${pkg} package and manage Client's YouTube advertising using those videos as ad creative. Weekly check-in calls (up to 1 hour) and advertising consulting are available on an as-needed basis. The deliverable is the production of the videos and management of advertising; Provider does not guarantee any specific number of leads, sales, or revenue.

3. Fees
- Setup fee: ${setup}, one-time, due on the first invoice.
- Monthly fee: ${monthly}/month for the ${pkg} package, billed monthly.
${adLine}4. Term
Four (4) month minimum commitment beginning on the date of first payment. After the initial term it continues month-to-month until either party cancels.

5. Refunds
All fees are non-refundable once paid, including if Client cancels mid-month. Client remains responsible for any outstanding ad-account and commission balances.
...
By paying the invoice associated with this agreement, Client (a) authorizes ConversionHero, LLC to charge the payment method on file for the setup fee, recurring monthly fee, and any applicable ad-spend commission, and (b) confirms Client has read, understood, and agrees to all terms herein.`
}
